...
pub fn draw_texture2(df: &mut DrawContext) -> Result<(), OglError> {
    if !df.initialized || df.draw_func != DrawFunc::DrawTexture2 {
        let v_src = r#"
                #version 300 es
        ...
        df.initialized = true;
        df.draw_func = DrawFunc::DrawTexture2;
        ...
        unsafe {
            ...
            let vertices = [
                //x        y      z             s       t
                -0.5f32, -0.5f32, -0.5f32,      0.0f32, 1.0f32,     //v0
                -0.5f32, -0.5f32,  0.5f32,      0.0f32, 0.0f32,     //v1
                 0.5f32, -0.5f32,  0.5f32,      1.0f32, 0.0f32,     //v2
                 0.5f32, -0.5f32, -0.5f32,      1.0f32, 1.0f32,     //v3

                -0.5f32,  0.5f32, -0.5f32,      0.0f32, 1.0f32,     //v4
                -0.5f32,  0.5f32,  0.5f32,      0.0f32, 0.0f32,     //v5
                 0.5f32,  0.5f32,  0.5f32,      1.0f32, 0.0f32,     //v6
                 0.5f32,  0.5f32, -0.5f32,      1.0f32, 1.0f32,     //v7

                -0.5f32, -0.5f32, -0.5f32,      0.0f32, 1.0f32,     //v8  = v0
                -0.5f32,  0.5f32, -0.5f32,      0.0f32, 0.0f32,     //v9  = v4
                 0.5f32,  0.5f32, -0.5f32,      1.0f32, 0.0f32,     //v10 = v7
                 0.5f32, -0.5f32, -0.5f32,      1.0f32, 1.0f32,     //v11 = v3

                -0.5f32, -0.5f32,  0.5f32,      0.0f32, 1.0f32,     //v12 = v1
                -0.5f32,  0.5f32,  0.5f32,      0.0f32, 0.0f32,     //v13 = v5
                 0.5f32,  0.5f32,  0.5f32,      1.0f32, 0.0f32,     //v14 = v6
                 0.5f32, -0.5f32,  0.5f32,      1.0f32, 1.0f32,     //v15 = v2

                -0.5f32, -0.5f32, -0.5f32,      0.0f32, 1.0f32,     //v16 = v0
                -0.5f32, -0.5f32,  0.5f32,      0.0f32, 0.0f32,     //v17 = v1
                -0.5f32,  0.5f32,  0.5f32,      1.0f32, 0.0f32,     //v18 = v5
                -0.5f32,  0.5f32, -0.5f32,      1.0f32, 1.0f32,     //v19 = v4

                 0.5f32, -0.5f32, -0.5f32,      0.0f32, 1.0f32,     //v20 = v3
                 0.5f32, -0.5f32,  0.5f32,      0.0f32, 0.0f32,     //v21 = v2
                 0.5f32,  0.5f32,  0.5f32,      1.0f32, 0.0f32,     //v22 = v6
